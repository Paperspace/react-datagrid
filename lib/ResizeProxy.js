...
var ResizeProxy = function (_React$Component) {
    _inherits(ResizeProxy, _React$Component);

    function ResizeProxy() {
        _classCallCheck(this, ResizeProxy);

        return _possibleConstructorReturn(this, (ResizeProxy.__proto__ || Object.getPrototypeOf(ResizeProxy)).apply(this, arguments));
    }
