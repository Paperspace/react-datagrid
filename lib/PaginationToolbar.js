...
var PaginationToolbar = function (_React$Component) {
	...
	function PaginationToolbar() {
		...
		return _possibleConstructorReturn(this, (PaginationToolbar.__proto__ || Object.getPrototypeOf(PaginationToolbar)).apply(this, arguments));
	}
	...
	_createClass(PaginationToolbar, [{
		...
		key: 'preparePageSizes',
		value: function preparePageSizes(props) {
		...
		key: 'prepareIconProps',
		value: function prepareIconProps(props) {
		...
		key: 'renderDisplaying',
		value: function renderDisplaying(props) {
		...
		key: 'renderPageSize',
		value: function renderPageSize(props) {
		...
		key: 'icon',
		value: function icon(iconName, props) {
		...
		key: 'onIconMouseEnter',
		value: function onIconMouseEnter(props, iconProps) {
		...
		key: 'onIconMouseLeave',
		value: function onIconMouseLeave(props, iconProps) {
			var mouseOver = this.state.mouseOver;
